    ...
    return (
        <Box padding={3} background="neutral100" style={{ border: '1px solid #d8e6ff', borderRadius: 8, marginBottom: 10 }}>
            ...
            {resourceCatalog.length === 0 ? (
                ...
                /* Two-column grid of content type cards */
            ...
            case 'resources': {
                ...
                return (
                    <>
                        ...
                        <Box paddingBottom={4}>
                            <Typography variant="pi" textColor="neutral500" paddingBottom={1}>Path Pattern</Typography>
                            <TextInput
                                label="Path Pattern"
                        ...
                        {formData.type === 'alias' && (
                            <Box paddingBottom={4}>
                                <Typography variant="pi" textColor="neutral500" paddingBottom={1}>Alias Path</Typography>
                                <TextInput
                                    label="Alias Path"
                            ...
                            <Box style={{ flex: 1, minWidth: 0, paddingRight: panelOpen ? 16 : 0 }}>
                                <Flex justifyContent="space-between" alignItems="center" paddingBottom={3} wrap="wrap" gap={2}>
                                    ...
                                    <Flex gap={2} wrap="wrap">
                                        ...
                                        {activeTab === 'resources' && (
                                            <Button variant="secondary" startIcon={<Magic />} onClick={() => setWizardOpen(true)}>
                                                Wizard
                                            </Button>
                                        )}
                                            ...
                                            {(resourceRecorder.suggestions || []).length === 0 ? (
                                                ...
                                                (resourceRecorder.suggestions || []).slice(0, 50).map(item => (
                                                    <Box
                                                        ...
                                                        padding={3}
                                                        background="neutral0"
                                                        style={{ border: '1px solid #ececec', borderRadius: 8, marginBottom: 8 }}
                                                    >
                                                        <Flex justifyContent="space-between" alignItems="center" wrap="wrap" gap={2}>
                                                            <Box>
                                ...
                                {activeTab === 'resources' && resourceSubTab === 'builder' && (
                                    <BuilderCatalog
                                        ...
                                        onRefresh={loadResourceCatalog}
                                        onUse={buildResourceFromCatalog}
                                    />
                                )}
